                ...
                <div class="col-md-7">
                 ...
                 <div class="col-md-5 text-center">
                     <div class="home-img">
                         ...
                         <img src="<?php echo base_url('public/images/deutsch.png'); ?>" alt="Img App">
                     </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="owl-carousel screenshots-carousel">
                ...
                <div class="screenshot-item">
                        <img src="<?php echo base_url('public/images/francais.png'); ?>" alt="Img App">
                </div>
                <div class="screenshot-item">
                        <img src="<?php echo base_url('public/images/englisch.png'); ?>" alt="Img App">
                </div>
                <div class="screenshot-item">
                        <img src="<?php echo base_url('public/images/deutsch.png'); ?>" alt="Img App">
                </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="owl-carousel team-carousel">
                <div class="team-item">
                    <img src="<?php echo base_url('public/images/test.JPG'); ?>" alt="Team">
                    <h3>Issam Charef</h3>
                    <span>Informatik Student</span>
                </div>
                <div class="team-item">
                    <img src="<?php echo base_url('public/images/11.jpeg'); ?>" alt="Team">
                    <h3>Leon Etienne</h3>
